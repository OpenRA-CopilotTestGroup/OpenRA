...
class AudioListener:
    def __init__(self, asr_manager, stop_event):
        ...
        self.is_listening = True  # Add status tracking
    ...
    def __listen_loop(self):
        ...
        while not self.stop_event.is_set():
            try:
                if not self.is_listening:  # Add pause check
                    time.sleep(0.1)
                    continue
    ...
    def pause_listening(self):
        ...
        self.logger.info("pause_listening -> Microphone paused")
        
    def resume_listening(self):
        """Resume mic listening"""
        self.is_listening = True 
        self.logger.info("resume_listening -> Microphone resumed")
